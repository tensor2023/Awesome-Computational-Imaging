...
def _pre_calculate(x, k, scale_factor):
    ...
    FBC = torch.conj(FB)
    F2B = (FB.real**2 + FB.imag**2).to(torch.complex64)
...
def load_denoiser(device) -> Tuple[Callable, Tuple[float, float]]:
    ...
    path_to_model='/home/xqgao/2025/MIT/code/PnP/DPIR-master/model_zoo/drunet_color.pth'#'/home/xqgao/2025/MIT/code/PnP/DPIR-master/model_zoo/drunet_deblocking_color.pth'#
