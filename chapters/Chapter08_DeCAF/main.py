...
if not FLAGS.is_parsed():
    sys.argv = [
        'predict.py',
        '--flagfile=/home/xqgao/2025/MIT/code/NeRF_optics/DeCAF-master/datasets/Celegans_head/train_config.txt'
    ]
...
def main(argv):
    ...
    h5_file = h5py.File('/home/xqgao/2025/MIT/code/NeRF_optics/DeCAF-master/datasets/Celegans_head/Celegans_head.mat', 'r')
